			...
			<div class="panel-body">
				<form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="name" id="input-name" class="form-control" value="<?php echo $name; ?>" placeholder="<?php echo $entry_name; ?>">
							<?php if ($error_name) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="sort_order" id="input-sort-order" class="form-control" value="<?php echo $sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>">
						</div>
					</div>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="language<?php echo $language['language_id'] ?>">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-code-<?php echo $language['language_id'] ?>"><?php echo $entry_code_block ?></label>
								<div class="col-sm-10">
